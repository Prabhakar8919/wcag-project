...
def dashboard_view(request, project_id):
    ...
    if latest_scan:
        ...
        if not created:
            ...
            report.level_aa_issues = level_aa
            report.level_aaa_issues = level_aaa
            report.score_perceivable = score_perceivable
            report.score_operable = score_operable
            report.score_understandable = score_understandable
            report.score_robust = score_robust
            report.compliance_20 = compliance_20
            report.compliance_21 = compliance_21
            report.compliance_22 = compliance_22
            report.save()
