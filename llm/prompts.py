...
# Optimized prompt for LLaMA 3 via Groq to ensure strict JSON object output (required for JSON Mode)
...
CRITICAL: Return ONLY a raw JSON object containing an "issues" array. No markdown formatting, no code blocks, no preamble, and no concluding text.
